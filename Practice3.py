...
def eval_genomes(genomes, config):
    global game_speed, x_position_track, y_position_track, points, obstacles, x_position_back, y_position_back, dogs, generation, nets # The variable game_speed is to keep track how fast everything on our screen is moving.
    ...
    def tries_on_screen():
        global generation                         
        text = font.render(f"Intentos: {pop.generation+1}", True, (125, 31, 28)) 
