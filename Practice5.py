...
def main():
    ...
    while run:
        ...
        for obstacle in obstacles:
            ...
            if dist < 216 and player.doggo_rectangle.y == player.Y_POSITION and obstacle.rect.y==350:
                player.doggo_run = False
                player.doggo_jump = True
                player.doggo_duck = False
                player.doggo_dead = False
            elif dist < 255 and player.doggo_rectangle.y == player.Y_POSITION and obstacle.rect.y==287:
                player.doggo_run = False
                player.doggo_jump = False
                player.doggo_duck = True
                player.doggo_dead = False
            elif dist < 220 and player.doggo_rectangle.y == player.Y_POSITION_DUCK and obstacle.rect.y==350:
                player.doggo_run = False
                player.doggo_jump = True
                player.doggo_duck = False
                player.doggo_dead = False
